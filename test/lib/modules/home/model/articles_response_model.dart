...
class Results {
  ...
  Results.fromJson(Map<String, dynamic> json) {
    ...
    desFacet = List.castFrom<dynamic, String>(json['des_facet']);
    orgFacet = List.castFrom<dynamic, String>(json['org_facet']);
    perFacet = List.castFrom<dynamic, String>(json['per_facet']);
    geoFacet = List.castFrom<dynamic, String>(json['geo_facet']);
